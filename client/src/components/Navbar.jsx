  ...
  return (
    <nav className="p-4 bg-gray-800 text-white shadow-lg">
      <div className="flex justify-between items-center max-w-5xl mx-auto">
        ...
        <Link
          to="/"
          className="flex items-center gap-2 text-xl font-bold md:ml-[-90px] text-[27px] text-purple-100"
        >
          {/* <img src="/logo.webp" alt="Logo" className="w-10 h-10 rounded-tl-lg " /> */}
          <div className="p-2 rounded-tl-lg border border-black shadow-md bg-purple-500 px-4 text-gray-900">
            Tt
          </div>
          TLE Tracker
        </Link>
        ...
        {/* Mobile Menu Button */}
        <button
          className="md:hidden text-2xl transition duration-300 hover:text-gray-400"
        ...
        <div className="hidden md:flex gap-4 md:mr-[-90px]">
          <Link
            to="/"
            className="hover:text-gray-300 hover:bg-gray-700 px-3 py-2 rounded transition duration-300"
          >
            Home
          </Link>
          {isAuthenticated && (
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col items-center gap-2 mt-4 bg-gray-900 p-3 rounded-lg">
          <Link
            to="/"
            className="hover:text-gray-300 hover:bg-gray-700 w-full text-center py-2 rounded transition duration-300"
